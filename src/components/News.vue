  ...
  <div id="description-block">
    ...
    <div class="news-feed">
      ...
      <p id="description-text">
        The university's president, Prof. Dr. Dr. Lord Weyers was sent on a mission to Xandar to recruit further tutors and professors for Space University. <br>
        We all wish him a peaceful journey!
      </p>
      <img src="../assets/LordWeyers.png" style="height: 300px;width: 500px;" alt="Alt">
